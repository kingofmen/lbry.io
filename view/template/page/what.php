...
<main class="ancillary">
  ...
  <section>
    <div class="inner-wrap">
      ...
      <p>If you're a programmer, you might recognize the LBRY blockchain as a <code>key-value store</code>. Each key, or name, corresponds to a value, or a metadata entry. Whichever party (or parties) bids the most LBC, gets to control the metadata returned by a key lookup.</p>
    ...
    <pre><span class="token prompt">$</span> lbrynet-cli resolve_name name=wonderfullife

wonderfullife<span class="token punctuation">:</span> <span class="token punctuation">{</span>
  title<span class="token punctuation">:</span> <span class="token string">"It's a Wonderful Life"</span><span class="token punctuation">,</span>
  description<span class="token punctuation">:</span> <span class="token string">"An angel helps a compassionate but despairingly frustrated businessman by showing what life would have been like if he never existed."</span><span class="token punctuation">,     </span>
  thumbnail<span class="token punctuation">:</span> <span class="token url">"https://spee.ch/@move:b/MW45x88.jpg"</span><span class="token punctuation">,</span>
  license<span class="token punctuation">:</span> <span class="token string">"public domain"</span><span class="token punctuation">,</span>
  price<span class="token punctuation">:</span> <span class="token integer">0</span><span class="token punctuation">,</span> <span class="token comment"># free!</span>
  publisher<span class="token punctuation">:</span> <span class="token string">"A Fan Of George Bailey"</span><span class="token punctuation">,</span> <span class="token comment"># simplification</span>
  sources<span class="token punctuation">:</span> <span class="token punctuation">{</span> <span class="token comment"># extensible, variable list</span>
    lbry_hash<span class="token punctuation">:</span> <span class="token string">"unique id"</span><span class="token punctuation">,</span>
...
<span class="token punctuation">}</span></code></pre>
  ...
  <section>
    <div class="inner-wrap">
      ...
      <p>Build our dream with us! <a class="link-primary" href="/get">Download LBRY</a>.</p>
    </div>
  </section>
</main>
